    ...
    SR: Send + 'static,
{
    ...
    ///
    /// [`StartJoinServerEvent`]: azalea_client::join::StartJoinServerEvent
    // In SwarmBuilder impl
    pub fn set_handler<Fut, NR>(self, handler: HandleFn<S, Fut>) -> SwarmBuilder<S, SS, NR, SR>
    where
        ...
        NR: Send + 'static,
    {
        ...
        SwarmBuilder {
            ...
            app: self.app,
            accounts: self.accounts,
            states: self.states, // Pass existing states!
    ...
    #[must_use]
    pub fn set_state<NewS>(self, state: NewS) -> SwarmBuilder<NewS, SS, R, SR>
    where
        NewS: Send + Sync + Clone + Component + 'static,
    {
        SwarmBuilder {
            app: self.app,
            accounts: self.accounts,
            ...
            // Old handler can't be kept as it expects S
            handler: None,
        }
    }
